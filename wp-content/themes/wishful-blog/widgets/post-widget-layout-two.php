<?php
/**
 * Post Widget Two Class
 *
 * @package wishful-blog
 */

if( ! class_exists( 'Wishful_Blog_Post_Widget_Layout_Two' ) ) {

    class Wishful_Blog_Post_Widget_Layout_Two extends WP_Widget {
	 ...
	 */
       public function __construct() {
           ...
           $widget_ops = array(
               'classname'     => 'wishful-blog-post-widget-layout-two',
               'description'   => 'Custom Wishful Blog Post Widget Layout Two',
           );
           parent::__construct(
               'wishful_blog_post_widget_layout_two',
               'WB : Post Widget Layout Two',
               $widget_ops
           );
       }
                        ...
                        <div class="trnd-post-box">
                            <div class="post-cover mb-3">
                                ...
                                if( has_post_thumbnail() ) {
                                    ...
                                    the_post_thumbnail( 'wishful-blog-thumbnail-one', array( 'alt' => the_title_attribute( array( 'echo' => false ) ) ) );

                                } else {

                                    wishful_blog_fallback_image( 'img', 'one' );
                                }
                                ?>
                               </a>
                            </div>
                ...
                <?php
                    ...
                    <div class="section-header">
                        <h3 class="text-danger">
                            <strong>
                                <?php esc_html_e( 'Place "Post Widget Layout Two" in "Sidebar or Footer Widget Area".', 'wishful-blog' ); ?>
                            </strong>
                        </h3>
                    </div><!-- Section Header /- -->
                    <?php
